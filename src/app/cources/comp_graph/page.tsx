        ...
        <div>
            <div className={styles.main}>
                <div className={styles.text}>
                    ...
                    <p>Курс <b>"Комп'ютерна графіка"</b> навчає роботі з програмами пакету <b>Photoshop та CorelDraw.</b></p>
                    <p><b>Photoshop</b> - це професійний растровий дизайнерський редактор. Основним призначенням програми є 
                        створення фотореалістичних зображень, ретушування, колірна корекція, створення колажів, а також 
                        web-дизайн і електронні публікації.</p>
                    <p><b> CorelDraw</b> - найпопулярніша програма для роботи із векторними зображеннями. Він активно 
                        застосовується у розробці логотипів, макетів печаток, веб-дизайні, створенні рекламного буклету тощо.</p>
                    <p>Навчаючись на курсі комп'ютерної графіки, слухачі не лише ознайомляться з роботою програм растрової 
                        та векторної графіки, а й зможуть підвищити якість робіт, освоїти тонкощі, що необхідні для 
                        виконання професійного дизайну.</p>
                </div>
                <Popup/>
